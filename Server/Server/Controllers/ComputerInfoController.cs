...
namespace Server.Controllers
{
	...
	public class ComputerInfoController : Controller
	{
		...
		[HttpGet("HDDs/{ComputerId}")]
		public async Task<IActionResult> GetHDDs(int ComputerId)
		{
			IActionResult response;
			try
			{
				var computerInfo = await _computerInfoRepository.GetHDDs(ComputerId);
		...
		[HttpGet("MotherBoard/{ComputerId}")]
		public async Task<IActionResult> GetMotherBoard(int ComputerId)
		{
			IActionResult response;
			try
			{
				var computerInfo = await _computerInfoRepository.GetMotherBoard(ComputerId);
		...
		[HttpGet("USBs/{ComputerId}")]
		public async Task<IActionResult> GetUSBs(int ComputerId)
		{
			IActionResult response;
			try
			{
				var computerInfo = await _computerInfoRepository.GetUSBs(ComputerId);
		...
		[HttpGet("Programms/{ComputerId}")]
		public async Task<IActionResult> GetProgramms(int ComputerId)
		{
			IActionResult response;
			try
			{
				var computerInfo = await _computerInfoRepository.GetProgramms(ComputerId);
